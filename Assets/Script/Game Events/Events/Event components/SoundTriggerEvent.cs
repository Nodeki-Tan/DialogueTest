...
namespace GameEvents
{
    ...
    [CreateAssetMenu(menuName = "Cinema/Event/Component/Sound Trigger")]
    public class SoundTriggerEvent : Event
    {

        public SoundPlayParameter enterParam;
        public SoundPlayParameter stayParam;
        public SoundPlayParameter exitParam;    
