...
public static class MathUtility {
    ...
    public static Vector3 V2ToXYZ (Vector2 v2, float yValue) {
        ...
        public static float GetPercentaje(float number, float desiredPercent)
    {
        return (desiredPercent / number) * 100;
    }

    public static float GetPercentajeOf(float number, float desiredPercent)
    {
        return (desiredPercent * number) / 100;
    }
